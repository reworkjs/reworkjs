...
import { ActiveLocaleContext } from '../common/active-locale-context.js';
import {
  onIntlHotReload,
  installLocale,
} from '../common/i18n';
...
import { guessPreferredLocale, LOCALE_COOKIE_NAME } from '../common/i18n/get-preferred-locale.js';
import { useAcceptLanguage } from '../common/ssr-browser-apis';
