...
export { useAsyncResource } from './use-async-resource/browser.js';
export { usePersistentValue } from './use-persistent-value/browser.js';
...
function getLanguages() {
  return Object.freeze(Array.from(navigator.languages));
}
